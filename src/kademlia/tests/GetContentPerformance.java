...
public class GetContentPerformance
{
    ...
    public GetContentPerformance()
    {
        try
        {
            ...
            kads[2] = new KademliaNode("user2", new NodeId("HRF456789SD584567463"), 4586);
            kads[3] = new KademliaNode("user3", new NodeId("HRF456789SD584567464"), 8107);
            kads[4] = new KademliaNode("user4", new NodeId("HRF456789SD584567465"), 8336);
            kads[5] = new KademliaNode("user5", new NodeId("HRF456789SD584567466"), 13346);
            kads[6] = new KademliaNode("user6", new NodeId("HRF456789SD584567468"), 12050);
            kads[7] = new KademliaNode("user7", new NodeId("HRF456789SD584567433"), 14586);
            kads[8] = new KademliaNode("user8", new NodeId("HRF456789SD58456746A"), 18105);
            kads[9] = new KademliaNode("user9", new NodeId("HRF456789SD58456746B"), 18336);
            ...
            c = new DHTContentImpl(new NodeId("HRF456789SD584567463"), "Joshua");
            c.setData(data);
